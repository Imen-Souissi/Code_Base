...
class PaymentSchedules extends DbModel implements DbModelFactoryInterface {
	protected $primary_key = 'id';
	
	public function __construct(Adapter $dbh, $database = 'contract') {
		parent::__construct($dbh, new TableIdentifier('payment_schedules', $database));
	}
	...
	public function insert($name, $next_payment_months, $active) {
