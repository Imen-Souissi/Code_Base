...
class AvailablePermissionsController extends AbstractRestfulController {
	public function getList() {
		...
		$items = $security_permissions_mdl->filterAvailable($filter, $this->getRange(), $this->getSort(), $total);
