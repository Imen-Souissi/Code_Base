...
// I just want to log these lines of code, they exist in the pdu variable
    ...
    protected function processEatonPdus() {
        ...
        // this $pdu is an array that we got when we filtered the table asset_devices as pdu/Eaton/ model
        // this gave us an array that has all the pdus to know tits size we can use sizeof(array)
        $pdus = $asset_devices_mdl->filter(
            array(
                'type' => 'pdu',
                'manufacturer' => 'Eaton',
        ...
        foreach($pdus as $pdu) {
            ...
            if (!empty($ips)) {
                ...
                $current = snmpget('10.176.13.11', "public", ".1.3.6.1.4.1.534.6.6.7.3.3.1.4.0.1.1");
                ...
                $voltage = snmpget('10.176.13.11', "public", ".1.3.6.1.4.1.534.6.6.7.3.2.1.3.0.1.1");
                ...
                // $power = snmpget($ips[0]['ip'], "public", ".1.3.6.1.4.1.534.6.6.7.3.4.1.4.0.1.1");
                  $power = snmpget('10.176.13.11', "public", ".1.3.6.1.4.1.534.6.6.7.3.4.1.4.0.1.1");
                if ($power) {
                    #$logger->log(Logger::INFO, 'power - ' . gettype($power) . ': ' . $power);
                    $power = (float)ltrim($power, 'INTEGER: ');
                    $power /= 1000;
