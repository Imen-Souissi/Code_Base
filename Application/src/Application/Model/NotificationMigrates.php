...
class NotificationMigrates extends DbModel implements DbModelFactoryInterface {
	protected $primary_key = 'id';
	protected $hr_database;
	
	public function __construct(Adapter $dbh, $database = 'app', $hr_database = 'hr') {
		$this->hr_database = $hr_database;
		parent::__construct($dbh, new TableIdentifier('notification_migrates', $database));
	}
	...
	public function insert(
		...
		return $this->_insert(array(
            ...
            'old_notification_id' => $old_notification_id
		));
	}
