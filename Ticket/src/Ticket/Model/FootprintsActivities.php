...
class FootprintsActivities extends DbModel implements DbModelFactoryInterface {
	protected $primary_key = 'id';
	
	public function __construct(Adapter $dbh, $database = 'ticket') {
		parent::__construct($dbh, new TableIdentifier('footprints_activities', $database));
	}
