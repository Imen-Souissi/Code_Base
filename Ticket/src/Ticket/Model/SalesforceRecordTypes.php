...
class SalesforceRecordTypes extends DbModel implements DbModelFactoryInterface {
	protected $primary_key = 'id';
    
	public function __construct(Adapter $dbh, $database = 'ticket') {
		parent::__construct($dbh, new TableIdentifier('salesforce_record_types', $database));
	}
