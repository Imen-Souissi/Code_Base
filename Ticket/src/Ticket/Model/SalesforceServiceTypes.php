...
class SalesforceServiceTypes extends DbModel implements DbModelFactoryInterface {
	protected $primary_key = 'id';
    
	public function __construct(Adapter $dbh, $database = 'ticket') {
		parent::__construct($dbh, new TableIdentifier('salesforce_service_types', $database));
	}
